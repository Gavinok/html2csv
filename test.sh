#!/bin/sh
./table_to_csv.py < tests/table_test_nomatch_tag/output.txt >   tests/table_test_nomatch_tag/results.csv
./table_to_csv.py < tests/table_test_badtag/output.txt >   tests/table_test_badtag/results.csv
